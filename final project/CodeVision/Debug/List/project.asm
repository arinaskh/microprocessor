...
_0x0:
	.DB  0x20,0x25,0x30,0x32,0x64,0x0,0x54,0x65
	.DB  0x6D,0x70,0x3D,0x25,0x64,0x20,0x20,0x0
	.DB  0x41,0x72,0x69,0x6E,0x61,0x27,0x73,0x20
	.DB  0x50,0x72,0x6F,0x6A,0x65,0x63,0x74,0x0
	.DB  0x70,0x72,0x65,0x73,0x73,0x5F,0x6B,0x65
	.DB  0x79,0x0,0x6B,0x65,0x79,0x20,0x69,0x73
...
;DATA STACK POINTER INITIALIZATION
	...
	.CSEG
;/*******************************************************
;Name:Arina Sadeghi Khiabanian
;Student Number:960171407
;Class:Saturday
;Time:10:50
;
...
;int get_key (void){
; 0000 0034 int get_key (void){
_get_key:
; .FSTART _get_key
; 0000 0035 DDRC = 0b00000000;
	LDI  R30,LOW(0)
	OUT  0x14,R30
; 0000 0036 PORTC = 0b00001111;//pc0_pc3
	LDI  R30,LOW(15)
	OUT  0x15,R30
; 0000 0037 //
; 0000 0038 DDRC = 0b00010000;
	LDI  R30,LOW(16)
	OUT  0x14,R30
; 0000 0039 if(PINC.0==0) return sprintf(s," %02d",7);//IR0
	SBIC 0x13,0
	RJMP _0x6
	CALL SUBOPT_0x0
	__GETD1N 0x7
	RJMP _0x2080004
; 0000 003A if(PINC.1==0) return sprintf(s," %02d",4);//IR1
_0x6:
	SBIC 0x13,1
	RJMP _0x7
	CALL SUBOPT_0x0
	__GETD1N 0x4
	RJMP _0x2080004
; 0000 003B if(PINC.2==0) return sprintf(s,"Temp=%d  ",(read_adc(0))/4);//IR2
_0x7:
	SBIC 0x13,2
	RJMP _0x8
	CALL SUBOPT_0x1
	LDI  R26,LOW(0)
	RJMP _0x2080005
; 0000 003C if(PINC.3==0) return 13;//IR3
_0x8:
	SBIC 0x13,3
	RJMP _0x9
	LDI  R30,LOW(13)
	...
	RET
; 0000 003D //
; 0000 003E DDRC = 0b00100000;
_0x9:
	LDI  R30,LOW(32)
	OUT  0x14,R30
; 0000 003F if(PINC.0==0) return sprintf(s," %02d",8);
	SBIC 0x13,0
	RJMP _0xA
	CALL SUBOPT_0x0
	__GETD1N 0x8
	RJMP _0x2080004
; 0000 0040 if(PINC.1==0) return sprintf(s," %02d",5);
_0xA:
	SBIC 0x13,1
	RJMP _0xB
	CALL SUBOPT_0x0
	__GETD1N 0x5
	RJMP _0x2080004
; 0000 0041 if(PINC.2==0) return sprintf(s,"Temp=%d  ",(read_adc(1))/4);//IR2
_0xB:
	SBIC 0x13,2
	RJMP _0xC
	CALL SUBOPT_0x1
	LDI  R26,LOW(1)
	RJMP _0x2080005
; 0000 0042 if(PINC.3==0) return 0;//IR3
_0xC:
	SBIC 0x13,3
	RJMP _0xD
	LDI  R30,LOW(0)
	...
	RET
; 0000 0043 //
; 0000 0044 DDRC = 0b01000000;
_0xD:
	LDI  R30,LOW(64)
	OUT  0x14,R30
; 0000 0045 if(PINC.0==0) return sprintf(s," %02d",9);//IR0
	SBIC 0x13,0
	RJMP _0xE
	CALL SUBOPT_0x0
	__GETD1N 0x9
	RJMP _0x2080004
; 0000 0046 if(PINC.1==0) return sprintf(s," %02d",6);//IR1
_0xE:
	SBIC 0x13,1
	RJMP _0xF
	CALL SUBOPT_0x0
	__GETD1N 0x6
	RJMP _0x2080004
; 0000 0047 if(PINC.2==0) return sprintf(s,"Temp=%d  ",(read_adc(2))/4);//IR2
_0xF:
	SBIC 0x13,2
	RJMP _0x10
	CALL SUBOPT_0x1
...
_0x2080004:
	...
	ADIW R28,8
	RET
; 0000 0048 if(PINC.3==0) return 14;//IR3
_0x10:
	SBIC 0x13,3
	RJMP _0x11
	LDI  R30,LOW(14)
	...
	RET
; 0000 0049 //
; 0000 004A DDRC = 0b10000000;
_0x11:
	LDI  R30,LOW(128)
	OUT  0x14,R30
; 0000 004B if(PINC.0==0) return 10;//IR0
	SBIC 0x13,0
	RJMP _0x12
	LDI  R30,LOW(10)
	LDI  R31,HIGH(10)
	RET
; 0000 004C if(PINC.1==0) return 11;//IR1
_0x12:
	SBIC 0x13,1
	RJMP _0x13
	LDI  R30,LOW(11)
	LDI  R31,HIGH(11)
	RET
; 0000 004D if(PINC.2==0) return 12;//IR2
_0x13:
	SBIC 0x13,2
	RJMP _0x14
	LDI  R30,LOW(12)
	LDI  R31,HIGH(12)
	RET
; 0000 004E if(PINC.3==0) return 15;//IR3
_0x14:
	SBIC 0x13,3
	RJMP _0x15
	LDI  R30,LOW(15)
...
; 0000 00C3 // RS - PORTA Bit 0
; 0000 00C4 // RD - PORTA Bit 1
; 0000 00C5 // EN - PORTA Bit 2
; 0000 00C6 // D4 - PORTA Bit 4
; 0000 00C7 // D5 - PORTA Bit 5
; 0000 00C8 // D6 - PORTA Bit 6
; 0000 00C9 // D7 - PORTA Bit 7
...
_0x16:
; 0000 00D4       {
; 0000 00D5       a=read_adc(0);
	LDI  R26,LOW(0)
	RCALL _read_adc
	MOVW R4,R30
; 0000 00D6       b=read_adc(1);
	LDI  R26,LOW(1)
	RCALL _read_adc
	MOVW R6,R30
; 0000 00D7       c=read_adc(2);
	LDI  R26,LOW(2)
	RCALL _read_adc
	MOVW R8,R30
; 0000 00D8 //       sprintf(s,"Temp=%d  ",a/4);
; 0000 00D9 //       lcd_gotoxy(0,0);
; 0000 00DA //       lcd_puts(s);
...
; 0000 00DC        lcd_gotoxy(0,0);
	...
	LDI  R26,LOW(0)
	CALL _lcd_gotoxy
; 0000 00DD        lcd_putsf("Arina's Project");
	__POINTW2FN _0x0,16
	CALL _lcd_putsf
; 0000 00DE        lcd_gotoxy(0,1);
	...
	LDI  R26,LOW(1)
	CALL _lcd_gotoxy
; 0000 00DF        lcd_putsf("press_key");
	__POINTW2FN _0x0,32
	CALL _lcd_putsf
; 0000 00E0         key = get_key();
	RCALL _get_key
	MOVW R16,R30
; 0000 00E1             if(key<255){
	__CPWRN 16,17,255
	BRGE _0x19
; 0000 00E2             sprintf(buffer,"key is=%d",key);
	MOVW R30,R28
	ST   -Y,R31
	ST   -Y,R30
	__POINTW1FN _0x0,42
